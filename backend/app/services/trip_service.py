...
from backend.app.core.messages.error_message import TRIP_NOT_FOUND
from backend.app.repositories.trip import (
    create_trip,
    get_trip_by_id,
...
from backend.app.schemas.trip import TripCreate, TripUpdate, TripOut
