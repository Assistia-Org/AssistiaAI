...
from backend.app.models.integration import Integration, IntegrationService
from backend.app.schemas.integration import IntegrationCreate, IntegrationUpdate
